...
import type { TablesInsert } from "@/integrations/supabase/types"; // ✅ Tipado correcto

export default function Transactions() {
  const [showForm, setShowForm] = useState(false);
  const [transactions, setTransactions] = useState<TablesInsert<"transactions">[]>([]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newTransaction: TablesInsert<"transactions"> = {
      type: String(formData.get("type")) as "Ingreso" | "Gasto",
    ...
    // Guardar en Supabase (⚙️ importante: usar arreglo [])
